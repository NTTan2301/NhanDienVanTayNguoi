...
namespace LuanVanTotNghiep
{
    ...
    public class ImageData
    {
        ...
        public ImageData( Bitmap bmp, int widthSquare)
        {
            Color c;
            image = new Int32[bmp.Width, bmp.Height];
            width = bmp.Width;
        ...
        public ImageData(Image sourceFile, int widthSquare)
        {
            Bitmap bmp = new Bitmap(sourceFile);
            Color c;
            image = new Int32[bmp.Width, bmp.Height];
        ...
        public ImageData(byte[] b, int widthSquare)
        {
        ...
        {
            //Ham tim truong dinh huong cua anh
            // widthSqare : kich thuoc cua so xem xet
            int i, j, x, y;
            int Ax, Ay, Axy;
            int Gxx, Gyy, Gxy;
            int Bx, By;
        ...
        {
            //ham chuan hoa hinh anh
            //M: gia tri ky vong mong muon
            //N: gia tri phuong sai mong muon
            double m = GetM();
            double v = GetV();
        ...
        //ho tro qua trinh chuan hoa anh
        private double GetM()
        {
            int temp = 0;
            for (int j = 0; j < height; j++)
        ...
        {
            //ham chuyen doi nhi phan hoa anh
            //thresh: nguong tu dong chuyen doi
            int thresthold;
        ...
        {
            //ham loc cac diem dac trung co trong anh
